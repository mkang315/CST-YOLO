...
Some heat maps are generated by [Grad-CAM](https://github.com/ramprs/grad-cam) from the test set of the [BCCD](https://github.com/Shenggan/BCCD_Dataset) dataset. Examples of heat maps and failure cases are shown in Fig. 1 and Fig. 2, respectively.</br>
<p float="left">
