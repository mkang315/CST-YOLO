...
## Experimental Validation in Different Domain
Table 4 compares the performance betwwen the original YOLOv7 and CST-YOLO on the [TinyPerson dataset](https://github.com/ucas-vg/PointTinyBenchmark/tree/TinyBenchmark) in a different domain from medical images. The experimental results demonstrate the effectivenss of CST-YOLO both in medical (i.e., blood cell) and natural image (i.e., tiny person) detection.  

**Table 4&nbsp;&nbsp;&nbsp;&nbsp;Performance comparison of YOLOv7 and CST-YOLO for TinyPerson dataset. The best results are shown in bold.**
