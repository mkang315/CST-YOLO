...
| :-------: | :-------: | :-------: | :-------: | :-------: | :-------: |
| &#xfeff | [DETR](https://github.com/facebookresearch/detr) | 0. | 0. | 0. | 0. |
| [BCCD](https://github.com/Shenggan/BCCD_Dataset) | [YOLOv5x](https://github.com/ultralytics/yolov5) | 0. | 0. | 0. | 0. |
| &#xfeff| [YOLOv7](https://github.com/WongKinYiu/yolov7) | 0. | 0. | 0. | **0.729** |
| &#xfeff | **CST-YOLO** | **0.936** | **0.945** | **0.946** | **0.729** |
